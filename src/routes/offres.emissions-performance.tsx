...
export const Route = createFileRoute("/offres/emissions-performance")({
  ...
  component: () => (
    <OfferPage
      ...
      intro="Un monitoring continu de vos émissions et rejets de gaz, pour mesurer l'efficacité réelle de vos systèmes d'abattage et optimiser vos cycles de production."
